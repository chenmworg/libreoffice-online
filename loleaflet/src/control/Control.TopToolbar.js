...
L.Control.TopToolbar = L.Control.extend({
	...
	getToolItems: function() {
		return [
			...
			{type: 'button', id: 'lefttoright', img: 'lefttoright', hidden: _UNO('.uno:ParaLeftToRight')},
			{type: 'button', id: 'righttoleft', img: 'righttoleft', hidden: _UNO('.uno:ParaRightToLeft')},
			...
			{type: 'button',  id: 'trackchanges', img: 'trackchanges', hint: _UNO('.uno:TrackChanges', '', true), hidden: true},
			{type: 'button',  id: 'showtrackedchanges', img: 'showtrackedchanges', hint: _UNO('.uno:ShowTrackedChanges', '', true), hidden: true},
