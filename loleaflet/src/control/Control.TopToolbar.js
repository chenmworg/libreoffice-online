...
L.Control.TopToolbar = L.Control.extend({
	...
	getToolItems: function() {
		return [
			...
			{type: 'button',  id: 'insertannotation', img: 'annotation', hint: _UNO('.uno:InsertAnnotation', '', true), hidden: true, tooltipPosition: 'left'},
			{type: 'button',  id: 'trackchanges', img: 'trackchanges', uno: 'TrackChanges',hint: _UNO('.uno:TrackChanges'), hidden: true, tooltipPosition: 'left'},
			{type: 'button',  id: 'showtrackedchanges', img: 'showtrackedchanges', uno: 'ShowTrackedChanges', hint: _UNO('.uno:ShowTrackedChanges'), hidden: true, tooltipPosition: 'left', },
